...
1. **Clone the repository**:
    ```bash
    git clone https://github.com/abhishekgurjarin/Focus-on-Day.git
    ```
...
You can check out the live demo of the Focus on Day project [here](https://abhishekgurjarin.github.io/Focus-on-Day/).
